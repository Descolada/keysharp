...
{
	/// <summary>
	/// SharpHook <see cref="KeyCode"/> ⇄ Windows VK and VK → <see cref="MouseButton"/>
	/// conversions. These are fixed tables (no layout/OS state), used by the SharpHook
	/// backends on X11 and macOS. Part of the unified <see cref="KeyCodes"/> facade.
	/// </summary>
	internal static partial class KeyCodes
	{
		public static KeyCode VkToSharpHook(uint vk)
		{
			switch (vk)
			{
			...
			return vk switch
			{
				...
				// Volume / media / browser / application keys
				VK_VOLUME_MUTE         => KeyCode.VcVolumeMute,
				VK_VOLUME_DOWN         => KeyCode.VcVolumeDown,
				VK_VOLUME_UP           => KeyCode.VcVolumeUp,
				VK_MEDIA_NEXT_TRACK    => KeyCode.VcMediaNext,
				VK_MEDIA_PREV_TRACK    => KeyCode.VcMediaPrevious,
				VK_MEDIA_STOP          => KeyCode.VcMediaStop,
				VK_MEDIA_PLAY_PAUSE    => KeyCode.VcMediaPlay,
				VK_BROWSER_BACK        => KeyCode.VcBrowserBack,
				VK_BROWSER_FORWARD     => KeyCode.VcBrowserForward,
				VK_BROWSER_REFRESH     => KeyCode.VcBrowserRefresh,
				VK_BROWSER_STOP        => KeyCode.VcBrowserStop,
				VK_BROWSER_SEARCH      => KeyCode.VcBrowserSearch,
				VK_BROWSER_FAVORITES   => KeyCode.VcBrowserFavorites,
				VK_BROWSER_HOME        => KeyCode.VcBrowserHome,
				VK_LAUNCH_MAIL         => KeyCode.VcAppMail,
				VK_LAUNCH_MEDIA_SELECT => KeyCode.VcMediaSelect,
				VK_LAUNCH_APP1         => KeyCode.VcApp1,
				VK_LAUNCH_APP2         => KeyCode.VcApp2,

				// Misc special keys
				VK_CANCEL      => KeyCode.VcCancel,
				VK_HELP        => KeyCode.VcHelp,
				VK_SLEEP       => KeyCode.VcSleep,

				_              => KeyCode.VcUndefined
			};
		}

		public static uint SharpHookToVk(KeyCode code)
		{
			// Symmetric reverse mapping of VkToSharpHook
			...
			switch (code)
			{
				...
				// Volume / media / browser / application keys
				case KeyCode.VcVolumeMute:       return VK_VOLUME_MUTE;
				case KeyCode.VcVolumeDown:       return VK_VOLUME_DOWN;
				case KeyCode.VcVolumeUp:         return VK_VOLUME_UP;
				case KeyCode.VcMediaNext:        return VK_MEDIA_NEXT_TRACK;
				case KeyCode.VcMediaPrevious:    return VK_MEDIA_PREV_TRACK;
				case KeyCode.VcMediaStop:        return VK_MEDIA_STOP;
				case KeyCode.VcMediaPlay:        return VK_MEDIA_PLAY_PAUSE;
				case KeyCode.VcBrowserBack:      return VK_BROWSER_BACK;
				case KeyCode.VcBrowserForward:   return VK_BROWSER_FORWARD;
				case KeyCode.VcBrowserRefresh:   return VK_BROWSER_REFRESH;
				case KeyCode.VcBrowserStop:      return VK_BROWSER_STOP;
				case KeyCode.VcBrowserSearch:    return VK_BROWSER_SEARCH;
				case KeyCode.VcBrowserFavorites: return VK_BROWSER_FAVORITES;
				case KeyCode.VcBrowserHome:      return VK_BROWSER_HOME;
				case KeyCode.VcAppMail:          return VK_LAUNCH_MAIL;
				case KeyCode.VcMediaSelect:      return VK_LAUNCH_MEDIA_SELECT;
				case KeyCode.VcApp1:             return VK_LAUNCH_APP1;
				case KeyCode.VcApp2:             return VK_LAUNCH_APP2;

				// Misc special keys
				case KeyCode.VcCancel:           return VK_CANCEL;
				case KeyCode.VcHelp:             return VK_HELP;
				case KeyCode.VcSleep:            return VK_SLEEP;
