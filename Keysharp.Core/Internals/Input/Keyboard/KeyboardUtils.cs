...
""".Bash(out var inputStr);
	...
	// Windows scan code values; used directly by the Win32 hook path. On Unix, scan-code
	// mapping is delegated to the active native backend via KeyCodes.
	...
	/// Non-Windows backends map these values to their native low-level codes via KeyCodes.
