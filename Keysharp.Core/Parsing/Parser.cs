    ...
    internal partial class Parser
	{
		...
		public class Function
        {
			...
			public BlockSyntax AssembleBody()
            {
                ...
                {
					var dereferenceType = SyntaxFactory.ParseTypeName("Keysharp.Runtime.Variables.Dereference");
                    ...
                    arguments.Add(
                        SyntaxFactory.Argument(
                            SyntaxFactory.MemberAccessExpression(
                                ...
                                CreateQualifiedName("Keysharp.Runtime.eScope"),
                    ...
                    //   new Keysharp.Runtime.Script.Variables.Dereference()
                    ...
                    // Create the variable declaration: "Dereference _ks_Derefs = new Keysharp.Runtime.Variables.Dereference();"
