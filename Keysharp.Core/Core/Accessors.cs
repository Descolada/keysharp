namespace Keysharp.Core
{
	...
	public static class Accessors
	{
		...
		/// </summary>
		public static StringPrimitive A_AhkBuildVersion
		{
			get
			{
		...
		/// </summary>
		public static StringPrimitive A_AhkPath => Application.ExecutablePath;

		/// <summary>
		/// The version of Keysharp.Core.dll
		/// </summary>
		public static StringPrimitive A_AhkVersion
		{
			get
			{
		...
		{
			get => (LongPrimitive)Script.TheScript.AccessorData.allowMainWindow;

			set
			{
				var val = Options.OnOff(value.Ap());
		...
		/// Linux: ~/
		/// </summary>
		public static StringPrimitive A_AppData =>
#if WINDOWS
		...
		/// </summary>
		public static StringPrimitive A_AppDataCommon => Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData);
		...
		/// </summary>
		public static StringPrimitive A_AsmCompany
		{
			get
			{
		...
		/// </summary>
		public static StringPrimitive A_AsmConfiguration
		{
			get
			{
		...
		/// </summary>
		public static StringPrimitive A_AsmCopyright
		{
			get
			{
		...
		/// </summary>
		public static StringPrimitive A_AsmDescription
		{
			get
			{
		...
		/// </summary>
		public static StringPrimitive A_AsmProduct
		{
			get
			{
		...
		/// </summary>
		public static StringPrimitive A_AsmTitle
		{
			get
			{
		...
		/// </summary>
		public static StringPrimitive A_AsmTrademark
		{
			get
			{
		...
		/// </summary>
		public static StringPrimitive A_AsmVersion
		{
			get
			{
			...
			set
			{
				Script.TheScript.mainWindow.CheckedInvoke(() =>
				{
					...
					if (WindowsAPI.OpenClipboard(A_ClipboardTimeout.Al()))
					{
						...
						if (value == null || (value is StringPrimitive s && s.IsEmpty))
							Clipboard.Clear();
						else if (value is ClipboardAll arr)
		...
		/// </summary>
		public static object A_ClipboardTimeout { get; set; } = (LongPrimitive)1000L;

		/// <summary>
		/// The name of the computer as seen on the network.
		/// </summary>
		public static StringPrimitive A_ComputerName => Environment.MachineName;
		...
		/// </summary>
		public static StringPrimitive A_ComSpec => Environment.GetEnvironmentVariable("COMSPEC");
		...
		{
			get => (LongPrimitive)ThreadAccessors.A_ControlDelay;
		...
		{
			get => (StringPrimitive)CoordModeTypeToString(ThreadAccessors.A_CoordModeCaret);
		...
		{
			get => (StringPrimitive)CoordModeTypeToString(ThreadAccessors.A_CoordModeMenu);
		...
		{
			get => (StringPrimitive)CoordModeTypeToString(ThreadAccessors.A_CoordModeMouse);
		...
		{
			get => (StringPrimitive)CoordModeTypeToString(ThreadAccessors.A_CoordModePixel);
		...
		{
			get => (StringPrimitive)CoordModeTypeToString(ThreadAccessors.A_CoordModeToolTip);
		...
		/// </summary>
		public static StringPrimitive A_Cursor =>
		...
		/// See <see cref="A_MDay"/>.
		/// </summary>
		public static StringPrimitive A_DD => A_MDay;

		/// <summary>
		/// Current day of the week's 3-letter abbreviation in the current user's language, e.g. Sun.
		/// </summary>
		public static StringPrimitive A_DDD => DateTime.Now.ToString("ddd");

		/// <summary>
		/// Current day of the week's full name in the current user's language, e.g. Sunday.
		/// </summary>
		public static StringPrimitive A_DDDD => DateTime.Now.ToString("dddd");
		...
		{
			get => (LongPrimitive)ThreadAccessors.A_DefaultMouseSpeed;
		...
		/// </summary>
		public static StringPrimitive A_Desktop => Environment.GetFolderPath(Environment.SpecialFolder.Desktop);

		/// <summary>
		/// The full path and name of the folder containing the all-users desktop files.
		/// </summary>
		public static StringPrimitive A_DesktopCommon => Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory);
		...
		{
			get => (LongPrimitive)ThreadAccessors.A_DetectHiddenText;
		...
		{
			get => (LongPrimitive)ThreadAccessors.A_DetectHiddenWindows;
		...
		/// </summary>
		public static DoublePrimitive A_E => Math.E;
		...
		/// </summary>
		public static StringPrimitive A_EndChar
		{
			get;
			internal set;
		}
		...
		{
			get => (StringPrimitive)(string)ThreadAccessors.A_FileEncoding;

			set
			{
				var val = Files.GetEncoding(value.As());
		...
		/// </summary>
		public static object A_HotIfTimeout { get; set; } = (LongPrimitive)1000L;
		...
		{
			get => (LongPrimitive)Script.TheScript.AccessorData.hotkeyThrottleInterval;
		...
		{
			get => (LongPrimitive)Script.TheScript.AccessorData.hotkeyModifierTimeout;
		...
		/// </summary>
		public static StringPrimitive A_Hour => DateTime.Now.ToString("HH");
		...
		/// </summary>
		public static StringPrimitive A_IconFile { get; internal set; } = "";
		...
		{
			get => (LongPrimitive)Script.TheScript.AccessorData.iconHidden;
		...
		/// </summary>
		public static LongPrimitive A_IconNumber { get; internal set; } = 1L;
		...
		{
			get => (StringPrimitive)(Script.TheScript.Tray != null ? Script.TheScript.Tray.Text : "");
		...
		public static object A_Index
		{
			get
			{
				...
				return (LongPrimitive)(s.TryPeek(out var result) ? result.index : default);
			}
			set
			{
				var s = Loops.LoopStack;
		...
		/// </summary>
		public static StringPrimitive A_InitialWorkingDir => Script.TheScript.AccessorData.initialWorkingDir;
		...
		{
			get => (LongPrimitive)Script.TheScript.AccessorData.inputLevel;
		...
		/// </summary>
		public static LongPrimitive A_Is64bitOS => true;

		/// <summary>
		/// True if the current user has administrator rights, false otherwise.
		/// </summary>
		public static LongPrimitive A_IsAdmin
		{
			get
			{
#if LINUX
		...
		/// </summary>
		public static LongPrimitive A_IsCompiled
		{
			get
			{
		...
		/// </summary>
		public static LongPrimitive A_IsCritical
		{
			get
			{
		...
		/// </summary>
		public static LongPrimitive A_IsSuspended => Script.TheScript.FlowData.suspended;

		/// <summary>
		/// Only for compatibility with AHK, C# programs are always unicode.
		/// </summary>
		public static LongPrimitive A_IsUnicode => true;
		...
		/// </summary>
		public static LongPrimitive A_KeybdHookInstalled => Script.TheScript.HookThread is HookThread ht
		...
		{
			get => (LongPrimitive)ThreadAccessors.A_KeyDelay;
		...
		{
			get => (LongPrimitive)ThreadAccessors.A_KeyDelayPlay;
		...
		{
			get => (LongPrimitive)ThreadAccessors.A_KeyDuration;
		...
		{
			get => (LongPrimitive)ThreadAccessors.A_KeyDurationPlay;
		...
		/// <see cref="A_AhkPath"/>.
		/// </summary>
		public static StringPrimitive A_KeysharpPath => A_AhkPath;

		/// <summary>
		/// The result from the Windows GetLastError() function.
		/// </summary>
		public static LongPrimitive A_LastError => Marshal.GetLastPInvokeError();//This apparently works on linux too.
		...
		/// </summary>
		public static Primitive A_LoopField
		{
			get
			{
				var s = Loops.LoopStack;
				...
				foreach (var l in s)//Since loop is a stack, this goes in reverse order, which is what we want.
				{
					...
					{
						case LoopType.Parse:
							return Primitive.From(l.result);
						...
						case LoopType.Each:
							{
								...
								return so.Length > 0 ? Primitive.From(so[1]) : DefaultObject;
							}
					}
				}
		...
		/// </summary>
		public static StringPrimitive A_LoopFileAttrib
		{
			get
			{
				if (A_LoopFileFullPath.ToString() is string s && (File.Exists(s) || Directory.Exists(s)))
				{
					var val = "";
		...
		/// </summary>
		public static StringPrimitive A_LoopFileDir
		{
			get
			{
		...
		/// </summary>
		public static StringPrimitive A_LoopFileExt
		{
			get
			{
		...
		/// </summary>
		public static StringPrimitive A_LoopFileFullPath
		{
			get
			{
				var loop = Loops.GetDirLoop();
		...
		/// </summary>
		public static StringPrimitive A_LoopFileLongPath => A_LoopFileFullPath;

		/// <summary>
		/// The name of the file or folder currently retrieved (without the path).
		/// </summary>
		public static StringPrimitive A_LoopFileName
		{
			get
			{
				var file = Loops.GetDirLoopFilename();
		...
		/// </summary>
		public static StringPrimitive A_LoopFilePath
		{
			get
			{
				var loop = Loops.GetDirLoop();
		...
		/// </summary>
		public static StringPrimitive A_LoopFileShortName => A_LoopFileShortPath.ToString() is string s ? Path.GetFileName(s) : null;
		...
		/// </summary>
		public static StringPrimitive A_LoopFileShortPath
		{
			get
			{
				var loop = Loops.GetDirLoop();
		...
		/// </summary>
		public static LongPrimitive A_LoopFileSize
		{
			get
			{
				var file = Loops.GetDirLoopFilename();
		...
		/// </summary>
		public static LongPrimitive A_LoopFileSizeKB => (LongPrimitive)Primitive.FloorDivide(A_LoopFileSize, (Primitive)1024L);

		/// <summary>
		/// The size in Mbytes of the file currently retrieved, rounded down to the nearest integer.
		/// </summary>
		public static LongPrimitive A_LoopFileSizeMB => (LongPrimitive)Primitive.FloorDivide(A_LoopFileSize, (Primitive)(1024L * 1024L));

		/// <summary>
		/// The time the file was last accessed. Format YYYYMMDDHH24MISS.
		/// </summary>
		public static StringPrimitive A_LoopFileTimeAccessed
		{
			get
			{
				var file = Loops.GetDirLoopFilename();
		...
		/// </summary>
		public static StringPrimitive A_LoopFileTimeCreated
		{
			get
			{
				var file = Loops.GetDirLoopFilename();
		...
		/// </summary>
		public static StringPrimitive A_LoopFileTimeModified
		{
			get
			{
				var file = Loops.GetDirLoopFilename();
		...
		/// </summary>
		public static StringPrimitive A_LoopReadLine
		{
			get
			{
				var s = Loops.LoopStack;
		...
		/// </summary>
		public static StringPrimitive A_LoopRegKey
		{
			get
			{
				var s = Loops.LoopStack;
		...
		/// </summary>
		public static StringPrimitive A_LoopRegName
		{
			get
			{
				var s = Loops.LoopStack;
		...
		/// </summary>
		public static StringPrimitive A_LoopRegTimeModified
		{
			get
			{
				var s = Loops.LoopStack;
		...
		/// </summary>
		public static StringPrimitive A_LoopRegType
		{
			get
			{
				var s = Loops.LoopStack;
		...
		{
			get => (LongPrimitive)Script.TheScript.AccessorData.maxHotkeysPerInterval;
		...
		/// </summary>
		public static object A_MaxThreadsPerHotkey { get; set; } = (LongPrimitive)1L;

		/// <summary>
		/// Current 2-digit day of the month (01-31).
		/// </summary>
		public static StringPrimitive A_MDay => DateTime.Now.ToString("dd");
		...
		{
			get => (LongPrimitive)Script.TheScript.AccessorData.menuMaskKey;
			set => Script.TheScript.AccessorData.menuMaskKey = value.As();
		}

		/// <summary>
		/// Current 2-digit minute (00-59).
		/// </summary>
		public static StringPrimitive A_Min => DateTime.Now.ToString("mm");

		/// <summary>
		/// Current 2-digit month (01-12). Synonymous with <see cref="A_Mon"/>.
		/// </summary>
		public static StringPrimitive A_MM => A_Mon;

		/// <summary>
		/// Current month's abbreviation in the current user's language, e.g. Jul.
		/// </summary>
		public static StringPrimitive A_MMM => DateTime.Now.ToString("MMM");

		/// <summary>
		/// Current month's full name in the current user's language, e.g. July.
		/// </summary>
		public static StringPrimitive A_MMMM => DateTime.Now.ToString("MMMM");

		/// <summary>
		/// Current 2-digit month (01-12).
		/// </summary>
		public static StringPrimitive A_Mon => DateTime.Now.ToString("MM");
		...
		{
			get => (LongPrimitive)ThreadAccessors.A_MouseDelay;
		...
		{
			get => (LongPrimitive)ThreadAccessors.A_MouseDelayPlay;
		...
		/// </summary>
		public static LongPrimitive A_MouseHookInstalled => Script.TheScript.HookThread is HookThread ht
		...
		/// </summary>
		public static StringPrimitive A_MSec => DateTime.Now.ToString("fff");

		/// <summary>
		/// The full path and name of the current user's "My Documents" folder.
		/// Need a cross platform way to do this.//TODO
		/// </summary>
		public static StringPrimitive A_MyDocuments => Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments);

		/// <summary>
		/// The native newline string, i.e. "\n" on linux, "\r\n" on Windows.
		/// </summary>
		public static StringPrimitive A_NewLine => Environment.NewLine;

		/// <summary>
		/// The current local time in YYYYMMDDHH24MISS format.
		/// </summary>
		public static StringPrimitive A_Now => Conversions.ToYYYYMMDDHH24MISS(DateTime.Now);

		/// <summary>
		/// The current Coordinated Universal Time (UTC) in YYYYMMDDHH24MISS format.
		/// </summary>
		public static StringPrimitive A_NowUTC => Conversions.ToYYYYMMDDHH24MISS(DateTime.UtcNow);
		...
		/// </summary>
		public static StringPrimitive A_OSType => Conversions.ToOSType(Environment.OSVersion.Platform);

		/// <summary>
		/// The Operating System version, e.g. WIN_VISTA, WIN_2003, WIN_XP, WIN_2000, WIN_NT4, WIN_95, WIN_98, WIN_ME.
		/// </summary>
		public static StringPrimitive A_OSVersion => $"{Environment.OSVersion.Version.Major}.{Environment.OSVersion.Version.Minor}.{Environment.OSVersion.Version.Build}";
		...
		{
			get => (LongPrimitive)ThreadAccessors.A_PeekFrequency;
		...
		/// </summary>
		public static DoublePrimitive A_PI => Math.PI;

		/// <summary>
		/// The key name of the previously executed hotkey or hotstring.
		/// </summary>
		public static StringPrimitive A_PriorHotkey => Script.TheScript.priorHotkeyName;

		/// <summary>
		/// The default priority to use for each thread.
		/// </summary>
		public static object A_Priority { get; set; } = (LongPrimitive)0L;

		/// <summary>
		/// The last key typed.
		/// All input generated by the script is excluded.
		/// </summary>
		public static StringPrimitive A_PriorKey => Script.TheScript.HookThread is HookThread ht ? ht.keyHistory.PriorKey() : "";

		/// <summary>
		/// The full path and name of the Program Files directory (e.g. C:\Program Files).
		/// </summary>
		public static StringPrimitive A_ProgramFiles => Environment.GetFolderPath(Environment.SpecialFolder.ProgramFiles);

		/// <summary>
		/// The full path and name of the Programs folder in the current user's Start Menu.
		/// </summary>
		public static StringPrimitive A_Programs => Environment.GetFolderPath(Environment.SpecialFolder.Programs);

		/// <summary>
		/// The full path and name of the Programs folder in the all-users Start Menu.
		/// </summary>
		public static StringPrimitive A_ProgramsCommon => Environment.GetFolderPath(Environment.SpecialFolder.Startup);

		/// <summary>
		/// The size in bytes of a pointer, always 8.
		/// </summary>
		public static LongPrimitive A_PtrSize => 8L;
		...
		{
			get => (LongPrimitive)ThreadAccessors.A_RegView;

			set
			{
				var val = value is StringPrimitive s && s.Value.Equals("default", StringComparison.CurrentCultureIgnoreCase) ? 64L : value.Al() == 32L ? 32L : 64L;
		...
		/// </summary>
		public static DoublePrimitive A_ScreenDPI
		{
			get
			{
		...
		/// </summary>
		public static LongPrimitive A_ScreenHeight => System.Windows.Forms.Screen.PrimaryScreen.Bounds.Height;

		/// <summary>
		/// The width of the primary monitor in pixels.
		/// </summary>
		public static LongPrimitive A_ScreenWidth => System.Windows.Forms.Screen.PrimaryScreen.Bounds.Width;

		/// <summary>
		/// The directory the script is running in.
		/// This will be the location of the executable if it's a compiled Script.TheScript.
		/// </summary>
		public static StringPrimitive A_ScriptDir
		{
			get
			{
				var script = Script.TheScript;
		...
		/// </summary>
		public static StringPrimitive A_ScriptFullPath => A_IsCompiled ? A_AhkPath : Script.TheScript.scriptName;

		/// <summary>
		/// The unique ID (HWND/handle) of the script's hidden main window.
		/// </summary>
		public static LongPrimitive A_ScriptHwnd => Script.TheScript.MainWindowHandle.ToInt64();

		/// <summary>
		/// The file name of the script.
		/// </summary>
		public static StringPrimitive A_ScriptName => Path.GetFileName(Script.TheScript.scriptName);

		/// <summary>
		/// Current 2-digit second (00-59).
		/// </summary>
		public static StringPrimitive A_Sec => DateTime.Now.ToString("ss");
		...
		{
			get => (LongPrimitive)ThreadAccessors.A_SendLevel;
		...
		{
			get => (StringPrimitive)ThreadAccessors.A_SendMode.ToString();
		...
		/// </summary>
		public static StringPrimitive A_Space => " ";

		/// <summary>
		/// The full path and name of the current user's Start Menu folder.
		/// </summary>
		public static StringPrimitive A_StartMenu => Environment.GetFolderPath(Environment.SpecialFolder.StartMenu);

		/// <summary>
		/// The full path and name of the all-users Start Menu folder.
		/// </summary>
		public static StringPrimitive A_StartMenuCommon => Environment.GetFolderPath(Environment.SpecialFolder.StartMenu);

		/// <summary>
		/// The full path and name of the Startup folder in the current user's Start Menu.
		/// </summary>
		public static StringPrimitive A_Startup => Environment.GetFolderPath(Environment.SpecialFolder.Startup);

		/// <summary>
		/// The full path and name of the Startup folder in the all-users Start Menu.
		/// </summary>
		public static StringPrimitive A_StartupCommon => Environment.GetFolderPath(Environment.SpecialFolder.Startup);
		...
		{
			get => (LongPrimitive)ThreadAccessors.A_StoreCapsLockMode;
		...
		/// </summary>
		public static StringPrimitive A_Tab => "\t";

		/// <summary>
		/// The full path and name of the folder designated to hold temporary files.
		/// </summary>
		public static StringPrimitive A_Temp => Path.GetTempPath().TrimEnd(Path.DirectorySeparatorChar);

		/// <summary>
		/// Temporary file name.
		/// </summary>
		public static StringPrimitive A_TempFile => Path.GetTempFileName();

		/// <summary>
		/// The name of the function currently being executed.
		/// </summary>
		public static StringPrimitive A_ThisFunc => new StackFrame(1).GetMethod().Name;

		/// <summary>
		/// The key name of the most recently executed hotkey or hotstring.
		/// </summary>
		public static StringPrimitive A_ThisHotkey => Script.TheScript.thisHotkeyName;

		/// <summary>
		/// The name of the menu from which A_ThisMenuItem was selected.
		/// </summary>
		public static StringPrimitive A_ThisMenu => null;

		/// <summary>
		/// The name of the most recently selected custom menu item (blank if none).
		/// </summary>
		public static StringPrimitive A_ThisMenuItem => null;
		...
		/// </summary>
		public static StringPrimitive A_ThisMenuItemPos => null;

		/// <summary>
		/// The number of milliseconds since the computer was rebooted.
		/// </summary>
		public static LongPrimitive A_TickCount => Environment.TickCount64;
		...
		/// </summary>
		public static LongPrimitive A_TimeIdle
		{
			get
			{
#if WINDOWS
		...
		/// </summary>
		public static LongPrimitive A_TimeIdleKeyboard => Script.TheScript.HookThread is HookThread ht && ht.HasKbdHook()
		...
		/// Otherwise, this variable is equivalent to <see cref="A_TimeIdle"/>.
		/// </summary>
		public static LongPrimitive A_TimeIdleMouse => Script.TheScript.HookThread is HookThread ht && ht.HasMouseHook()
		...
		/// </summary>
		public static LongPrimitive A_TimeIdlePhysical => Script.TheScript.HookThread is HookThread ht && ht.HasEitherHook()
		...
		/// </summary>
		public static LongPrimitive A_TimeSincePriorHotkey => string.IsNullOrEmpty(Script.TheScript.priorHotkeyName) ? -1L : (long)(DateTime.UtcNow - Script.TheScript.priorHotkeyStartTime).TotalMilliseconds;
		...
		/// </summary>
		public static LongPrimitive A_TimeSinceThisHotkey => string.IsNullOrEmpty(Script.TheScript.thisHotkeyName) ? -1L : (long)(DateTime.UtcNow - Script.TheScript.thisHotkeyStartTime).TotalMilliseconds;
		...
		public static object A_TitleMatchMode
		{
			get
			{
				...
				return l == 4L ? (StringPrimitive)Keyword_RegEx : (LongPrimitive)l;
			}
			set
			{
				var script = Script.TheScript;
		...
		{
			get => (StringPrimitive)(ThreadAccessors.A_TitleMatchModeSpeed ? Keyword_Fast : Keyword_Slow);
		...
		/// </summary>
		public static StringPrimitive A_UserName => Environment.UserName;

		/// <summary>
		/// Current 1-digit day of the week (1-7). 1 is Sunday in all locales.
		/// </summary>
		public static LongPrimitive A_WDay => (int)DateTime.Now.DayOfWeek + 1;
		...
		{
			get => (LongPrimitive)ThreadAccessors.A_WinDelay;
		...
		/// </summary>
		public static StringPrimitive A_WinDir => Environment.GetFolderPath(Environment.SpecialFolder.Windows);
		...
		/// </summary>
		public static StringPrimitive A_WorkingDir
		{
		...
		/// </summary>
		public static LongPrimitive A_YDay => DateTime.Now.DayOfYear;

		/// <summary>
		/// Current 4-digit year (e.g. 2004).
		/// </summary>
		public static LongPrimitive A_Year => DateTime.Now.Year;

		/// <summary>
		/// Current year and week number (e.g. 200453) according to ISO 8601.
		/// </summary>
		public static StringPrimitive A_YWeek
		{
			get
			{
		...
		/// See <see cref="A_Year"/>.
		/// </summary>
		public static LongPrimitive A_YYYY => A_Year;

		/// <summary>
		/// The numeric value for False, 0.
		/// </summary>
		public static LongPrimitive False => 0L;

		/// <summary>
		/// The numeric value for True, 1.
		/// </summary>
		public static LongPrimitive True => 1L;
		...
		/// </summary>
		public static Primitive A_ExitReason
		{
			get;
			internal set;
		} = "";
		...
		/// </summary>
		internal static bool A_IconFrozen
		{
	...
	public static partial class KeysharpEnhancements
	{
		...
		/// </summary>
		public static object A_AllowTimers { get; set; } = (LongPrimitive)true;

		/// <summary>
		/// The command line string used to run the script.
		/// </summary>
		public static StringPrimitive A_CommandLine
		{
			get
			{
		...
		/// </summary>
		public static LongPrimitive A_DefaultHotstringCaseSensitive => Script.TheScript.HotstringManager.hsCaseSensitive;

		/// <summary>
		/// The default case conformity of hotstrings.
		/// </summary>
		public static LongPrimitive A_DefaultHotstringConformToCase => Script.TheScript.HotstringManager.hsConformToCase;

		/// <summary>
		/// The default inside word detection of hotstrings.
		/// </summary>
		public static LongPrimitive A_DefaultHotstringDetectWhenInsideWord => Script.TheScript.HotstringManager.hsDetectWhenInsideWord;

		/// <summary>
		/// The default backspacing of hotstrings.
		/// </summary>
		public static LongPrimitive A_DefaultHotstringDoBackspace => Script.TheScript.HotstringManager.hsDoBackspace;

		/// <summary>
		/// The default recognizer reset mode of hotstrings.
		/// </summary>
		public static LongPrimitive A_DefaultHotstringDoReset => Script.TheScript.HotstringManager.hsDoReset;

		/// <summary>
		/// The default end char mode of hotstrings.
		/// </summary>
		public static LongPrimitive A_DefaultHotstringEndCharRequired => Script.TheScript.HotstringManager.hsEndCharRequired;

		/// <summary>
		/// The default end chars of hotstrings.
		/// </summary>
		public static StringPrimitive A_DefaultHotstringEndChars => Script.TheScript.HotstringManager.defEndChars;

		/// <summary>
		/// The default end chars of hotstrings.
		/// </summary>
		public static LongPrimitive A_DefaultHotstringKeyDelay => Script.TheScript.HotstringManager.hsKeyDelay;

		/// <summary>
		/// Whether mouse clicks reset the hotstring recognizer.
		/// </summary>
		public static LongPrimitive A_DefaultHotstringNoMouse => !Script.TheScript.HotstringManager.hsResetUponMouseClick;

		/// <summary>
		/// The default end char omission mode of hotstrings.
		/// </summary>
		public static LongPrimitive A_DefaultHotstringOmitEndChar => Script.TheScript.HotstringManager.hsOmitEndChar;

		/// <summary>
		/// The default priority of hotstrings.
		/// </summary>
		public static LongPrimitive A_DefaultHotstringPriority => Script.TheScript.HotstringManager.hsPriority;

		/// <summary>
		/// The default send mode of hotstrings.
		/// </summary>
		public static StringPrimitive A_DefaultHotstringSendMode
		{
			get
			{
		...
		/// </summary>
		public static StringPrimitive A_DefaultHotstringSendRaw
		{
			get
			{
		...
		/// </summary>
		public static StringPrimitive A_DirSeparator => Path.DirectorySeparatorChar.ToString();

		/// <summary>
		/// Whether the script has exited yet.
		/// </summary>
		public static LongPrimitive A_HasExited => Script.TheScript.hasExited;

		/// <summary>
		/// The path to Keysharp.Core.Dll
		/// </summary>
		public static StringPrimitive A_KeysharpCorePath => Assembly.GetAssembly(typeof(Accessors)).Location;
		...
		/// </summary>
		public static LongPrimitive A_MaxThreads => (long)Script.TheScript.MaxThreadsTotal;

		/// <summary>
		/// The value specified by #NoTrayIcon.
		/// Disables the showing of a tray icon.
		/// </summary>
		public static LongPrimitive A_NoTrayIcon => Script.TheScript.NoTrayIcon;

		/// <summary>
		/// The current local time in YYYYMMDDHH24MISS.fff format.
		/// </summary>
		public static StringPrimitive A_NowMs => Conversions.ToYYYYMMDDHH24MISSFFF(DateTime.Now);

		/// <summary>
		/// The current Coordinated Universal Time (UTC) in YYYYMMDDHH24MISS.fff format.
		/// </summary>
		public static StringPrimitive A_NowUtcMs => Conversions.ToYYYYMMDDHH24MISSFFF(DateTime.UtcNow);

		/// <summary>
		/// Whether the script is exempt from being able to be suspended.
		/// </summary>
		public static Primitive A_SuspendExempt
		{
			get => Script.TheScript.HotstringManager.hsSuspendExempt;
			set => Script.TheScript.HotstringManager.hsSuspendExempt = value.IsTrue;
		}

		/// <summary>
		/// The total height in pixels of the virtual screen.
		/// </summary>
		public static LongPrimitive A_TotalScreenHeight => SystemInformation.VirtualScreen.Height;

		/// <summary>
		/// The total width in pixels of the virtual screen.
		/// </summary>
		public static LongPrimitive A_TotalScreenWidth => SystemInformation.VirtualScreen.Width;

		/// <summary>
		/// The value specified by #UseHook.
		/// </summary>
		public static LongPrimitive A_UseHook => Script.TheScript.ForceKeybdHook;

		/// <summary>
		/// Whether #WinActivateForce was specified.
		/// </summary>
		public static LongPrimitive A_WinActivateForce => Script.TheScript.WinActivateForce;

		/// <summary>
		/// The height of the working area of the primary screen.
		/// </summary>
		public static LongPrimitive A_WorkAreaHeight => System.Windows.Forms.Screen.PrimaryScreen.WorkingArea.Height;

		/// <summary>
		/// The width of the working area of the primary screen.
		/// </summary>
		public static LongPrimitive A_WorkAreaWidth => System.Windows.Forms.Screen.PrimaryScreen.WorkingArea.Width;
	}
	...
	internal static class ThreadAccessors
	{
		...
		internal static CoordModeType GetCoordMode(CoordMode mode)
		{
			return mode switch
			{
				...
				_ => (CoordModeType)(int)Errors.ValueErrorOccurred($"Invalid coordinate mode type: {mode}", null, (int)CoordModeType.Client)
			};
		}
