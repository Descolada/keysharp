...
namespace Keysharp.Internals.UI.Windows
{
	partial class MainWindow
	{
		...
		private void InitializeComponent()
		{
			...
			txtDebug = new Keysharp.Internals.UI.Windows.NonFocusTextBox();
			tpVars = new System.Windows.Forms.TabPage();
			txtVars = new Keysharp.Internals.UI.Windows.NonFocusTextBox();
			tpHotkeys = new System.Windows.Forms.TabPage();
			txtHotkeys = new Keysharp.Internals.UI.Windows.NonFocusTextBox();
			tpHistory = new System.Windows.Forms.TabPage();
			txtHistory = new Keysharp.Internals.UI.Windows.NonFocusTextBox();
		...
		private Keysharp.Internals.UI.Windows.NonFocusTextBox txtDebug;
		private Keysharp.Internals.UI.Windows.NonFocusTextBox txtVars;
		private System.Windows.Forms.TabPage tpHotkeys;
		private Keysharp.Internals.UI.Windows.NonFocusTextBox txtHotkeys;
		private System.Windows.Forms.TabPage tpHistory;
		private Keysharp.Internals.UI.Windows.NonFocusTextBox txtHistory;
