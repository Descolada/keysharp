...
public abstract class MainLexerBase : Lexer
{
    ...
    private bool _allowStringModeTrivia = true;
    ...
    public override IToken NextToken()
    {
        ...
        {
            EndStringMode();
            throw new Keysharp.Builtins.ParseException("Unterminated string literal", next);
        }
    ...
    {
        _allowStringModeTrivia = true;
        BeginStringModeCore(quote);
    }

    protected void BeginDirectiveStringMode(char quote = '\0')
    {
    ...
    {
        return _allowStringModeTrivia;
    }

    private void BeginStringModeCore(char quote)
    {
        _stringQuote = quote;
    ...
    protected void ProcessContinuationSection()
    {
        ...
        {
			singleLine = Keysharp.Parsing.Parser.MultilineString(originalSegment, 0, this.SourceName);
        ...
        singleLine = Keysharp.Parsing.Parser.ParseContinuationSection(originalSegment, 0, this.SourceName);
        if (NeedsSpaceBeforeContinuationSection())
