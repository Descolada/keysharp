...
public interface IPreprocessorParserVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitPreprocessorImportDirective([NotNull] PreprocessorParser.PreprocessorImportDirectiveContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitImportDirective([NotNull] PreprocessorParser.ImportDirectiveContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="PreprocessorParser.importModule"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitImportModule([NotNull] PreprocessorParser.ImportModuleContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="PreprocessorParser.importList"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitImportList([NotNull] PreprocessorParser.ImportListContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="PreprocessorParser.importSpecifierList"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitImportSpecifierList([NotNull] PreprocessorParser.ImportSpecifierListContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="PreprocessorParser.importSpecifier"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitImportSpecifier([NotNull] PreprocessorParser.ImportSpecifierContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="PreprocessorParser.importModuleName"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitImportModuleName([NotNull] PreprocessorParser.ImportModuleNameContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="PreprocessorParser.importDirectiveIdentifier"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitImportDirectiveIdentifier([NotNull] PreprocessorParser.ImportDirectiveIdentifierContext context);
	/// <summary>
