...
namespace Keysharp.Tests
{
	...
	public partial class HotstringTests : TestRunner
	{
		...
		public void CreateHotstring()
		{
			...
			hsm.RestoreDefaults(true);
			_ = Keyboard.Hotstring("Reset");
			_ = Keysharp.Core.Common.Keyboard.HotstringManager.AddHotstring("::btw", (Core.Common.Invoke.IFuncObj)Functions.Func(label_9F201721, null).AsObject(), ":btw", "btw", "", false);
