...
namespace Keysharp.Core
{
	...
	public static class Mouse
	{
										 ...
										 object flag = null)
		{
			...
			if (outputVarX != null) Script.SetPropertyValue(outputVarX, "__Value", (LongPrimitive)(pos.X - aX));//Convert the mouse position in screen coordinates to window coordinates.
			if (outputVarY != null) Script.SetPropertyValue(outputVarY, "__Value", (LongPrimitive)(pos.Y - aY));
			...
			if (outputVarWin != null) Script.SetPropertyValue(outputVarWin, "__Value", (LongPrimitive)parent.Handle);
#if WINDOWS
			...
			if ((mode & 0x02) != 0)
			{
				if (outputVarControl != null) Script.SetPropertyValue(outputVarControl, "__Value", (LongPrimitive)child.Handle);
				return DefaultObject;
			}

			if (outputVarControl != null) Script.SetPropertyValue(outputVarControl, "__Value", (StringPrimitive)child.ClassNN);
			return DefaultObject;
		}
