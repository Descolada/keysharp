...
public partial class PreprocessorParser : PreprocessorParserBase {
	...
	public Preprocessor_directiveContext preprocessor_directive() {
		...
		try {
			...
			case Assembly:
				...
				State = 98;
				_la = TokenStream.LA(1);
				if ( !(((((_la - 165)) & ~0x3f) == 0 && ((1L << (_la - 165)) & 131143L) != 0)) ) {
			...
			case Warn:
				...
				State = 106;
				_la = TokenStream.LA(1);
				if ( !(((((_la - 152)) & ~0x3f) == 0 && ((1L << (_la - 152)) & 327681L) != 0)) ) {
				ErrorHandler.RecoverInline(this);
				}
				else {
					ErrorHandler.ReportMatch(this);
			...
			case MaxThreadsPerHotkey:
				...
				State = 121;
				_la = TokenStream.LA(1);
				if ( !(((((_la - 174)) & ~0x3f) == 0 && ((1L << (_la - 174)) & 31L) != 0)) ) {
				ErrorHandler.RecoverInline(this);
				}
				else {
					ErrorHandler.ReportMatch(this);
	...
	private static int[] _serializedATN = {
		4,1,196,217,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,
		...
		12,14,16,18,0,5,3,0,165,167,171,171,182,182,2,0,75,76,146,146,3,0,152,
		152,168,168,170,170,1,0,174,178,1,1,186,186,253,0,124,1,0,0,0,2,126,1,
		0,0,0,4,129,1,0,0,0,6,135,1,0,0,0,8,140,1,0,0,0,10,146,1,0,0,0,12,163,
		1,0,0,0,14,167,1,0,0,0,16,169,1,0,0,0,18,189,1,0,0,0,20,21,5,154,0,0,21,
		22,5,184,0,0,22,23,3,2,1,0,23,24,6,0,-1,0,24,125,1,0,0,0,25,26,5,155,0,
		0,26,27,5,184,0,0,27,28,3,2,1,0,28,29,6,0,-1,0,29,125,1,0,0,0,30,31,5,
		106,0,0,31,32,3,18,9,0,32,33,3,2,1,0,33,34,6,0,-1,0,34,125,1,0,0,0,35,
		36,5,156,0,0,36,37,3,18,9,0,37,38,3,2,1,0,38,39,6,0,-1,0,39,125,1,0,0,
		0,40,41,5,92,0,0,41,42,3,2,1,0,42,43,6,0,-1,0,43,125,1,0,0,0,44,45,5,157,
		0,0,45,46,3,2,1,0,46,47,6,0,-1,0,47,125,1,0,0,0,48,55,5,158,0,0,49,51,
		5,146,0,0,50,52,5,137,0,0,51,50,1,0,0,0,51,52,1,0,0,0,52,56,1,0,0,0,53,
		56,5,91,0,0,54,56,5,183,0,0,55,49,1,0,0,0,55,53,1,0,0,0,55,54,1,0,0,0,
		56,57,1,0,0,0,57,58,3,2,1,0,58,59,6,0,-1,0,59,125,1,0,0,0,60,61,5,159,
		0,0,61,62,5,137,0,0,62,63,3,2,1,0,63,64,6,0,-1,0,64,125,1,0,0,0,65,66,
		5,160,0,0,66,67,5,137,0,0,67,68,3,2,1,0,68,69,6,0,-1,0,69,125,1,0,0,0,
		70,72,5,161,0,0,71,73,5,137,0,0,72,71,1,0,0,0,72,73,1,0,0,0,73,74,1,0,
		0,0,74,75,3,2,1,0,75,76,6,0,-1,0,76,125,1,0,0,0,77,79,5,162,0,0,78,80,
		5,137,0,0,79,78,1,0,0,0,79,80,1,0,0,0,80,81,1,0,0,0,81,82,3,2,1,0,82,83,
		6,0,-1,0,83,125,1,0,0,0,84,85,5,163,0,0,85,86,5,137,0,0,86,87,3,2,1,0,
		87,88,6,0,-1,0,88,125,1,0,0,0,89,90,5,164,0,0,90,91,5,137,0,0,91,92,3,
		2,1,0,92,93,6,0,-1,0,93,125,1,0,0,0,94,95,5,127,0,0,95,96,3,4,2,0,96,97,
		3,2,1,0,97,125,1,0,0,0,98,99,7,0,0,0,99,100,5,137,0,0,100,125,3,2,1,0,
		101,103,5,169,0,0,102,104,7,1,0,0,103,102,1,0,0,0,103,104,1,0,0,0,104,
		105,1,0,0,0,105,125,3,2,1,0,106,108,7,2,0,0,107,109,5,137,0,0,108,107,
		1,0,0,0,108,109,1,0,0,0,109,110,1,0,0,0,110,125,3,2,1,0,111,112,5,172,
		0,0,112,125,3,2,1,0,113,114,5,173,0,0,114,125,3,2,1,0,115,116,5,179,0,
		0,116,125,3,2,1,0,117,118,5,181,0,0,118,125,3,2,1,0,119,120,5,180,0,0,
		120,125,3,2,1,0,121,122,7,3,0,0,122,123,5,146,0,0,123,125,3,2,1,0,124,
		...
		1,1,0,0,0,126,127,7,4,0,0,127,3,1,0,0,0,128,130,5,126,0,0,129,128,1,0,
		0,0,129,130,1,0,0,0,130,131,1,0,0,0,131,133,3,6,3,0,132,134,3,8,4,0,133,
		132,1,0,0,0,133,134,1,0,0,0,134,5,1,0,0,0,135,138,3,14,7,0,136,137,5,129,
		...
		159,160,5,129,0,0,160,162,3,16,8,0,161,159,1,0,0,0,161,162,1,0,0,0,162,
		164,1,0,0,0,163,157,1,0,0,0,163,158,1,0,0,0,164,13,1,0,0,0,165,168,3,16,
		8,0,166,168,5,137,0,0,167,165,1,0,0,0,167,166,1,0,0,0,168,15,1,0,0,0,169,
		170,5,135,0,0,170,17,1,0,0,0,171,172,6,9,-1,0,172,173,5,75,0,0,173,190,
		6,9,-1,0,174,175,5,76,0,0,175,190,6,9,-1,0,176,177,5,146,0,0,177,190,6,
		9,-1,0,178,179,5,184,0,0,179,190,6,9,-1,0,180,181,5,14,0,0,181,182,3,18,
		...
		5,55,0,0,203,204,3,18,9,3,204,205,6,9,-1,0,205,212,1,0,0,0,206,207,10,
		1,0,0,207,208,5,56,0,0,208,209,3,18,9,2,209,210,6,9,-1,0,210,212,1,0,0,
