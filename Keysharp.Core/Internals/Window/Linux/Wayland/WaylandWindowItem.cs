...
namespace Keysharp.Internals.Window.Linux.Wayland
{
	...
	/// These protocols do not expose geometry, child controls, PID, or window text.
	/// </summary>
	internal sealed class WaylandWindowItem : WindowItemBase
	{
		...
		internal override long ExStyle { get => 0; set { } }
		...
		internal override long PID => 0;
		internal override Size Size { get => Size.Empty; set { } }
		internal override long Style { get => 0; set { } }
		...
		// Wayland has no forceful kill; sends a close request that the application may refuse.
